...
const MyNFTs = Loadable(lazy(() => import('./pages/dashboard/MyNFTs')));
const ViewNFT = Loadable(lazy(() => import('./pages/dashboard/ViewNFT')));
...
const NFTAccountProfile = Loadable(lazy(() => import('./pages/dashboard/NFTAccountProfile')));
